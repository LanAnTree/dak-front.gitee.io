! function(t, e) {
	...
	function l(t, e, i) {
		...
		if (void 0 === i && 1 === t.nodeType)
			if (n = "data-" + e.replace(It, "-$&")
				.toLowerCase(), i = t.getAttribute(n), "string" == typeof i) {
				try {
	...
	function C(t) {
		var e = G,
			i = Yt[t];
		return i || (i = E(t, e), "none" !== i && i || ($t = ($t || ot("<iframe frameborder='0' width='0' height='0'/>"))
			.appendTo(e.documentElement), e = $t[0].contentDocument, e.write(), e.close(), i = E(t, e), $t.detach()), Yt[t] = i), i
	}
	...
	function M(t, e, i) {
		for (var n, r = (F.tweeners[e] || [])
			.concat(F.tweeners["*"]), o = 0, s = r.length; s > o; o++)
	...
	function z(t, e, i) {
		...
		if (ot.isEmptyObject(f)) "inline" === ("none" === h ? C(t.nodeName) : h) && (d.display = h);
			...
			m ? "hidden" in m && (p = m.hidden) : m = Ct.access(t, "fxshow", {}), o && (m.hidden = !p), p ? ot(t)
	...
	function F(t, e, i) {
		...
		for (j(u, h.opts.specialEasing); s > o; o++)
			if (n = F.prefilters[o].call(h, t, u, h.opts)) return ot.isFunction(n.stop) && (ot._queueHooks(h.elem, h.opts.queue)
				.stop = ot.proxy(n.stop, n)), n;
	...
	ot.fn = ot.prototype = {
		...
		globalEval: function(t) {
			var e, i = eval;
			t = ot.trim(t), t && (1 === t.indexOf("use strict") ? (e = G.createElement("script"), e.text = t, G.head.appendChild(e)
				.parentNode.removeChild(e)) : i(t))
		},
		camelCase: function(t) {
			return t.replace(at, "ms-")
				.replace(lt, ht)
		},
	...
	var ut = function(t) {
			...
			for (var e, i, n, r = t.length, o = x.relative[t[0].type], s = o || x.relative[" "], a = o ? 1 : 0, l = d(function(t) {
				...
				if (i = x.relative[t[a].type]) u = [d(p(u), i)];
					...
					if (i = x.filter[t[a].type].apply(null, t[a].matches), i[F]) {
						...
						return v(a > 1 && p(u), a > 1 && f(t.slice(0, a - 1)
								.concat({
									value: " " === t[a - 2].type ? "*" : ""
								}))
		...
		T = e.support = {}, E = e.isXML = function(t) {
			...
			return n !== O && 9 === n.nodeType && n.documentElement ? (O = n, L = O.documentElement, N = !E(O), (i = O.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", xt, !1) : i.attachEvent && i.attachEvent("onunload", xt)), T.attributes = r(function(t) {
				...
				return t.appendChild(O.createComment("")), !t.getElementsByTagName("*")
					.length
			}), T.getElementsByClassName = gt.test(O.getElementsByClassName), T.getById = r(function(t) {
				return L.appendChild(t)
					.id = F, !O.getElementsByName || !O.getElementsByName(F)
					.length
				...
				L.appendChild(t)
					.innerHTML = "<a id='" + F + "'></a><select id='" + F + "-\r\\' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']")
					.length && R.push("[*^$]=" + it + "*(?:''|\"\")"), t.querySelectorAll("[selected]")
					.length || R.push("\\[" + it + "*(?:value|" + et + ")"), t.querySelectorAll("[id~=" + F + "-]")
					.length || R.push("~="), t.querySelectorAll(":checked")
					.length || R.push(":checked"), t.querySelectorAll("a#" + F + "+*")
					.length || R.push(".#.+[+~]")
			}), r(function(t) {
				var e = O.createElement("input");
				e.setAttribute("type", "hidden"), t.appendChild(e)
					.setAttribute("name", "D"), t.querySelectorAll("[name=d]")
					.length && R.push("name" + it + "*[*^$|!~]?="), t.querySelectorAll(":enabled")
					.length || R.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), R.push(",.*:")
			...
			preFilter: {
				ATTR: function(t) {
					return t[1] = t[1].replace(bt, Tt), t[3] = (t[3] || t[4] || t[5] || "")
						.replace(bt, Tt), "~=" === t[2] && (t[3] = " " + t[3] + " "), t.slice(0, 4)
				},
				CHILD: function(t) {
			...
			filter: {
				...
				ATTR: function(t, i, n) {
					return function(r) {
						var o = e.attr(r, t);
						return null == o ? "!=" === i : !i || (o += "", "=" === i ? o === n : "!=" === i ? o !== n : "^=" === i ? n && 0 === o.indexOf(n) : "*=" === i ? n && o.indexOf(n) > -1 : "$=" === i ? n && o.slice(-n.length) === n : "~=" === i ? (" " + o.replace(st, " ") + " ")
							.indexOf(n) > -1 : "|=" === i && (o === n || o.slice(0, n.length + 1) === n + "-"))
					}
				},
			...
			pseudos: {
				...
				lang: n(function(t) {
					return ft.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(bt, Tt)
						.toLowerCase(),
						function(e) {
							var i;
							do
		...
		return c.prototype = x.filters = x.pseudos, x.setFilters = new c, C = e.tokenize = function(t, i) {
				...
				return i ? a.length : a ? e.error(t) : V(t, l)
					.slice(0)
				...
				if (i = i || [], 1 === c.length) {
					if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (s = o[0])
						.type && T.getById && 9 === e.nodeType && N && x.relative[o[1].type]) {
			...
			}, T.sortStable = F.split("")
			.sort($)
			.join("") === F, T.detectDuplicates = !!P, k(), T.sortDetached = r(function(t) {
	...
	ot.filter = function(t, e, i) {
		...
		find: function(t) {
			var e, i = this.length,
				n = [],
				r = this;
			if ("string" != typeof t) return this.pushStack(ot(t)
				.filter(function() {
					for (e = 0; i > e; e++)
		...
		is: function(t) {
			return !!n(this, "string" == typeof t && dt.test(t) ? ot(t) : t || [], !1)
				.length
		}
	});
	var gt, vt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
		yt = ot.fn.init = function(t, e, i) {
			...
			if (i = i || gt, "string" == typeof t) {
				if (n = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : vt.exec(t), !n || !n[1] && e) return !e || e.jquery ? (e || i)
	...
	ot.fn.extend({
		...
		index: function(t) {
			return t ? "string" == typeof t ? J.call(ot(t), this[0]) : J.call(this, t.jquery ? t[0] : t) : this[0] && this[0].parentNode ? this.first()
				.prevAll()
				.length : -1
		},
		add: function(t, e) {
	...
	ot.Callbacks = function(t) {
						...
						return ot.Deferred(function(i) {
								ot.each(e, function(e, o) {
									...
									r[o[1]](function() {
										...
										t && ot.isFunction(t.promise) ? t.promise()
											.progress(i.notify)
											.done(i.resolve)
											.fail(i.reject) : i[o[0] + "With"](this === n ? i.promise() : this, s ? [t] : arguments)
									})
								}), t = null
							})
							.promise()
		...
		when: function(t) {
			...
			if (s > 1)
				for (e = new Array(s), i = new Array(s), n = new Array(s); s > r; r++) o[r] && ot.isFunction(o[r].promise) ? o[r].promise()
					.progress(h(r, i, e))
					.done(h(r, n, o))
					.fail(l.reject) : --a;
	...
	ot.fn.ready = function(t) {
		...
		ready: function(t) {
			(t === !0 ? --ot.readyWait : ot.isReady) || (ot.isReady = !0, t !== !0 && --ot.readyWait > 0 || (xt.resolveWith(G, [ot]), ot.fn.triggerHandler && (ot(G)
				.triggerHandler("ready"), ot(G)
				.off("ready"))))
		}
	...
	ot.extend({
		...
		data: function(t, e) {
			...
			return "object" == typeof t ? this.each(function() {
				...
				var i, n;
				if (o && void 0 === e) {
					if (i = St.get(o, t) || St.get(o, t.replace(It, "-$&")
						.toLowerCase()), void 0 !== i) return i;
		...
		_queueHooks: function(t, e) {
			...
			return Ct.get(t, i) || Ct.access(t, i, {
				empty: ot.Callbacks("once memory")
					.add(function() {
	...
	! function() {
		...
		i.setAttribute("type", "radio"), i.setAttribute("checked", "checked"), i.setAttribute("name", "t"), e.appendChild(i), nt.checkClone = e.cloneNode(!0)
			.cloneNode(!0)
			.lastChild.checked, e.innerHTML = "<textarea>x</textarea>", nt.noCloneChecked = !!e.cloneNode(!0)
	...
	ot.event = {
		...
		add: function(t, e, i, n, r) {
			...
			if (g)
				for (i.handler && (o = i, i = o.handler, r = o.selector), i.guid || (i.guid = ot.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
					...
					.match(Tt) || [""], h = e.length; h--;) a = Wt.exec(e[h]) || [], d = m = a[1], p = (a[2] || "")
					.split(".")
					.sort(), d && (c = ot.event.special[d] || {}, d = (r ? c.delegateType : c.bindType) || d, c = ot.event.special[d] || {}, u = ot.extend({
						type: d,
						origType: m,
						data: n,
						handler: i,
		...
		remove: function(t, e, i, n, r) {
			...
			if (g && (l = g.events)) {
				for (e = (e || "")
					.match(Tt) || [""], h = e.length; h--;)
					if (a = Wt.exec(e[h]) || [], d = m = a[1], p = (a[2] || "")
						.split(".")
						.sort(), d) {
				...
				for (s = ot.event.handlers.call(this, t, l), e = 0;
					...
					for (t.currentTarget = r.elem, i = 0;
						(o = r.handlers[i++]) && !t.isImmediatePropagationStopped();) t.rnamespace && !t.rnamespace.test(o.namespace) || (t.handleObj = o, t.data = o.data, n = ((ot.event.special[o.origType] || {})
							.handle || o.handler)
						.apply(r.elem, a), void 0 !== n && (t.result = n) === !1 && (t.preventDefault(), t.stopPropagation()));
			...
			if (a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1))
				for (; l !== this; l = l.parentNode || this)
					if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
						for (n = [], i = 0; a > i; i++) o = e[i], r = o.selector + " ", void 0 === n[r] && (n[r] = o.needsContext ? ot(r, this)
							.index(l) > -1 : ot.find(r, this, null, [l])
							.length), n[r] && n.push(o);
						n.length && s.push({
							elem: l,
							handlers: n
		...
		off: function(t, e, i) {
			var n, r;
			if (t && t.preventDefault && t.handleObj) return n = t.handleObj, ot(t.delegateTarget)
	...
	ot.extend({
		...
		text: function(t) {
			return wt(this, function(t) {
				return void 0 === t ? ot.text(this) : this.empty()
					.each(function() {
	...
	! function() {
		...
		a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0)
			.style.backgroundClip = "", nt.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), ot.extend(nt, {
				...
				reliableMarginRight: function() {
					...
					return i.style.cssText = a.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", i.style.marginRight = i.style.width = "0", a.style.width = "1px", Zt.appendChild(s), e = !parseFloat(t.getComputedStyle(i)
						.marginRight), Zt.removeChild(s), a.removeChild(i), e
				}
			}))
	}();
	...
	ot.extend({
		...
		return e ? (parseFloat(S(t, "marginLeft")) || t.getBoundingClientRect()
			.left - Kt(t, {
				marginLeft: 0
			}, function() {
	...
	ot.fn.extend({
		addClass: function(t) {
			...
			if (ot.isFunction(t)) return this.each(function(e) {
				ot(this)
					.addClass(t.call(this, e, W(this)))
			});
			if ("string" == typeof t && t)
				for (e = t.match(Tt) || []; i = this[l++];)
					if (r = W(i), n = 1 === i.nodeType && (" " + r + " ")
						.replace(fe, " ")) {
		...
		removeClass: function(t) {
			...
			if (ot.isFunction(t)) return this.each(function(e) {
				ot(this)
					.removeClass(t.call(this, e, W(this)))
			});
		...
		toggleClass: function(t, e) {
			...
			return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ot.isFunction(t) ? this.each(function(i) {
				ot(this)
					.toggleClass(t.call(this, i, W(this), e), e)
			}) : this.each(function() {
				var e, n, r, o;
				if ("string" === i)
	...
	ot.fn.extend({
		val: function(t) {
			...
			return arguments.length ? (n = ot.isFunction(t), this.each(function(i) {
				var r;
				1 === this.nodeType && (r = n ? t.call(this, i, ot(this)
					.val()) : t, null == r ? r = "" : "number" == typeof r ? r += "" : ot.isArray(r) && (r = ot.map(r, function(t) {
					return null == t ? "" : t + ""
		...
		ot.valHooks[this] = {
			set: function(t, e) {
				return ot.isArray(e) ? t.checked = ot.inArray(ot(t)
					.val(), e) > -1 : void 0
			}
	...
	ot.parseJSON = function(t) {
		...
		return i && !i.getElementsByTagName("parsererror")
			.length || ot.error("Invalid XML: " + e), i
	};
	var _e = /#.*$/,
		be = /([?&])_=[^&]*/,
		Te = /^(.*?):[ \t]*([^\r\n]*)$/gm,
	...
	Ie.href = ge.href, ot.extend({
		...
		ajax: function(e, i) {
			...
			if (m.promise(x)
				.complete = g.add, x.success = x.done, x.error = x.fail, f.url = ((e || f.url || ge.href) + "")
				.replace(_e, "")
				.replace(Ee, ge.protocol + "//"), f.type = i.method || i.type || f.method || f.type, f.dataTypes = ot.trim(f.dataType || "*")
				.toLowerCase()
				.match(Tt) || [""], null == f.crossDomain) {
				h = G.createElement("a");
				try {
		...
		wrapAll: function(t) {
			...
			}) : (this[0] && (e = ot(t, this[0].ownerDocument)
				.eq(0)
		...
		return t.offsetWidth > 0 || t.offsetHeight > 0 || t.getClientRects()
			.length > 0
	};
	var De = /%20/g,
		Pe = /\[\]$/,
			...
			return this.map(function() {
				...
				.filter(function() {
					...
					return this.name && !ot(this)
						.is(":disabled") && Le.test(this.nodeName) && !Oe.test(t) && (this.checked || !Lt.test(t))
				})
				.map(function(t, e) {
					var i = ot(this)
						.val();
	...
	ot.ajaxSetup({
		...
		var r, o, s, a = e.jsonp !== !1 && (ze.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "")
			.indexOf("application/x-www-form-urlencoded") && ze.test(e.data) && "data");
		return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = ot.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(ze, "$1" + r) : e.jsonp !== !1 && (e.url += (ye.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
			...
			void 0 === o ? ot(t)
				.removeProp(r) : t[r] = o, e[r] && (e.jsonpCallback = i.jsonpCallback, Me.push(r)), s && ot.isFunction(o) && o(s[0]), s = o = void 0
		}), "script") : void 0
		...
		var n = pt.exec(t),
			r = !i && [];
		return n ? [e.createElement(n[1])] : (n = f([t], e, r), r && r.length && ot(r)
			.remove(), ot.merge([], n.childNodes))
	};
	var je = ot.fn.load;
	ot.fn.load = function(t, e, i) {
		...
		return a > -1 && (n = ot.trim(t.slice(a)), t = t.slice(0, a)), ot.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (r = "POST"), s.length > 0 && ot.ajax({
			...
			.done(function(t) {
				o = arguments, s.html(n ? ot("<div>")
					.append(ot.parseHTML(t))
					.find(n) : t)
			})
		...
		setOffset: function(t, e, i) {
			var n, r, o, s, a, l, h, u = ot.css(t, "position"),
				c = ot(t),
				f = {};
			"static" === u && (t.style.position = "relative"), a = c.offset(), o = ot.css(t, "top"), l = ot.css(t, "left"), h = ("absolute" === u || "fixed" === u) && (o + l)
				.indexOf("auto") > -1, h ? (n = c.position(), s = n.top, r = n.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), ot.isFunction(e) && (e = e.call(t, i, ot.extend({}, a))), null != e.top && (f.top = e.top - a.top + s), null != e.left && (f.left = e.left - a.left + r), "using" in e ? e.using.call(t, f) : c.css(f)
		}
	}, ot.fn.extend({
		offset: function(t) {
		...
		ot.cssHooks[e] = A(nt.pixelPosition, function(t, i) {
			return i ? (i = S(t, e), Gt.test(i) ? ot(t)
...
.push(function() {
		...
		_gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
				var n = function(t) {
					...
					c = [];
				o.version = "1.19.0", u.constructor = o, u.kill()
					._gc = !1, o.killTweensOf = o.killDelayedCallsTo = i.killTweensOf, o.getTweensOf = i.getTweensOf, o.lagSmoothing = i.lagSmoothing, o.ticker = i.ticker, o.render = i.render, u.invalidate = function() {
				...
				var f = function(t, e) {
					...
					d = o.getAllTweens = function(e) {
						return f(t._rootTimeline, e)
							.concat(f(t._rootFramesTimeline, e))
					};
				...
				var n = function(t) {
					...
					g = n.prototype = new e;
				return n.version = "1.19.0", g.constructor = n, g.kill()
					._gc = g._forcingPlayhead = g._hasPause = !1, g.to = function(t, e, n, r) {
						var o = n.repeat && c.TweenMax || i;
						return e ? this.add(new o(t, e, n), r) : this.set(t, n, r)
					}, g.from = function(t, e, n, r) {
						return this.add((n.repeat && c.TweenMax || i)
							.from(t, e, n), r)
				...
				var n = function(e) {
					...
					u = n.prototype = new t;
				return u.constructor = n, u.kill()
					._gc = !1, n.version = "1.19.0", u.invalidate = function() {
			...
			function() {
				...
				var u, c, f, d, p, m, g, v, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
					...
					Z = s.getStyle = function(t, e, i, n, r) {
						var o;
						return U || "opacity" !== e ? (!n && t.style[e] ? o = t.style[e] : (i = i || K(t)) ? o = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(A, "-$1")
							.toLowerCase()) : t.currentStyle && (o = t.currentStyle[e]), null == r || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : r) : $(t)
					},
					...
					st = function(t, e) {
						...
						if (n.length > 3 && !e) {
							for (n = t.split(", ")
								.join(",")
								.split(","), t = [], i = 0; i < n.length; i++) t.push(st(n[i]));
							return t.join(",")
						}
						return null == o ? o = "center" === r ? "50%" : "0" : "center" === o && (o = "50%"),
							("center" === r || isNaN(parseFloat(r)) && -1 === (r + "")
								.indexOf("=")) && (r = "50%"), t = r + " " + o + (n.length > 2 ? " " + n[2] : ""), e && (e.oxp = -1 !== r.indexOf("%"), e.oyp = -1 !== o.indexOf("%"), e.oxr = "=" === r.charAt(1), e.oyr = "=" === o.charAt(1), e.ox = parseFloat(r.replace(T, "")), e.oy = parseFloat(o.replace(T, "")), e.v = t), e || t
					},
					at = function(t, e) {
				...
				var mt = function(t, e, i, n) {
						...
						return u ? r = e ? function(t) {
							...
							if ("number" == typeof t) t += c;
								...
								for (p = t.replace(N, "|")
									.split("|"), d = 0; d < p.length; d++) p[d] = r(p[d]);
								return p.join(",")
							}
							if (e = (t.match(pt) || [o])[0], f = t.split(e)
								.join("")
								.match(b) || [], d = f.length, u > d--)
							...
							if ("number" == typeof t) t += c;
								...
								for (o = t.replace(N, "|")
									.split("|"), f = 0; f < o.length; f++) o[f] = r(o[f]);
								return o.join(",")
							}
					...
					bt = s.parseComplex = function(t, e, i, n, r, o, a, l, h, c) {
						...
						var f, d, p, m, b, T, x, w, E, C, S, A, I, D = i.split(", ")
							.join(",")
							.split(" "),
							P = n.split(", ")
							.join(",")
							...
							k = D.length,
							O = u !== !1;
						for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (D = D.join(" ")
							.replace(N, ", ")
							.split(" "), P = P.join(" ")
							.replace(N, ", ")
							.split(" "), k = D.length), k !== P.length && (D = (o || "")
							.split(" "), k = D.length), a.plugin = h, a.setRatio = c, pt.lastIndex = 0, f = 0; k > f; f++)
							if (m = D[f], b = P[f], w = parseFloat(m), w || 0 === w) a.appendXtra("", w, at(b, w), b.replace(_, ""), O && -1 !== b.indexOf("px"), !0);
							else if (r && pt.test(m)) A = b.indexOf(")") + 1, A = ")" + (A ? b.substr(A) : ""), I = -1 !== b.indexOf("hsl") && U, m = ft(m, I), b = ft(b, I), E = m.length + b.length > 6, E && !U && 0 === b[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(P[f])
							.join("transparent")) : (U || (E = !1), I ? a.appendXtra(E ? "hsla(" : "hsl(", m[0], at(b[0], m[0]), ",", !1, !0)
							.appendXtra("", m[1], at(b[1], m[1]), "%,", !1)
							.appendXtra("", m[2], at(b[2], m[2]), E ? "%," : "%" + A, !1) : a.appendXtra(E ? "rgba(" : "rgb(", m[0], b[0] - m[0], ",", !0, !0)
							.appendXtra("", m[1], b[1] - m[1], ",", !0)
							.appendXtra("", m[2], b[2] - m[2], E ? "," : A, !0), E && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (b.length < 4 ? 1 : b[3]) - m, A, !1))), pt.lastIndex = 0;
						else if (T = m.match(y)) {
				...
				h = xt.prototype, h.parseComplex = function(t, e, i, n, r, o) {
					...
					if (this.multi && (N.test(i) || N.test(e) ? (a = e.replace(N, "|")
						.split("|"), l = i.replace(N, "|")
						.split("|")) : f && (a = [e], l = [i])), l) {
						for (h = l.length > a.length ? l.length : a.length, s = 0; h > s; s++) e = a[s] = a[s] || this.dflt, i = l[s] = l[s] || this.dflt, f && (u = e.indexOf(f), c = i.indexOf(f), u !== c && (-1 === c ? a[s] = a[s].split(f)
							.join("") : -1 === u && (a[s] += " " + f)));
						e = a.join(", "), i = l.join(", ")
					}
				...
				var Ct, St = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
					...
					Lt = function(t, e, i) {
						var n, r = F.createElementNS("http://www.w3.org/2000/svg", t),
							o = /([a-z])([A-Z])/g;
						for (n in i) r.setAttributeNS(null, n.replace(o, "$1-$2")
							.toLowerCase(), i[n]);
					...
					Wt = function(t, e) {
						var i, n, r, o, s, a, l = t._gsTransform || new kt,
							h = 1e5,
							u = t.style;
						if (At ? n = Z(t, It, null, !0) : t.currentStyle && (n = t.currentStyle.filter.match(O), n = n && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, i && At && ((a = "none" === K(t)
							.display) || !t.parentNode) && (a && (o = u.display, u.display = "block"), t.parentNode || (s = 1, Nt.appendChild(t)), n = Z(t, It, null, !0), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, o ? u.display = o : a && Ut(u, "display"), s && Nt.removeChild(t)), (l.svg || t.getBBox && jt(t)) && (i && -1 !== (u[At] + "")
							.indexOf("matrix") && (n = u[At], i = 0), r = t.getAttribute("transform"), i && r && (-1 !== r.indexOf("matrix") ? (n = r, i = 0) : -1 !== r.indexOf("translate") && (n = "matrix(1,0,0,1," + r.match(/(?:\-|\b)[\d\-\.e]+\b/gi)
								.join(",") + ")", i = 0))), i) return Ft;
						for (r = (n || "")
							.match(y) || [], Tt = r.length; --Tt > -1;) o = Number(r[Tt]), r[Tt] = (s = o - (o |= 0)) ? (s * h + (0 > s ? -.5 : .5) | 0) / h + o : o;
					...
					Ht = q.getTransform = function(t, i, n, r) {
						...
						var o, a, l, h, u, c, f = n ? t._gsTransform || new kt : new kt,
							...
							p = 2e-5,
							m = 1e5,
							g = Pt ? parseFloat(Z(t, Dt, i, !1, "0 0 0")
				...
				h = kt.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, wt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
					parser: function(t, e, i, n, o, a, l) {
						...
						return D = C.transformOrigin, I.svg && (D || C.svgOrigin) && (m = I.xOffset, y = I.yOffset, Mt(t, st(D), u, C.svgOrigin, C.smoothOrigin), o = _t(I, "xOrigin", (T ? I : u)
							.xOrigin, u.xOrigin, o, A), o = _t(I, "yOrigin", (T ? I : u)
					...
					parser: function(t, e, i, o, s, a) {
						...
						var l, h, u, c, f, d, p, m, g, v, y, _, b, T, x, w, E = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
							C = t.style;
						for (g = parseFloat(t.offsetWidth), v = parseFloat(t.offsetHeight), l = e.split(" "), h = 0; h < E.length; h++) this.p.indexOf("border") && (E[h] = Q(E[h])), f = c = Z(t, E[h], r, !1, "0px"), -1 !== f.indexOf(" ") && (c = f.split(" "), f = c[0], c = c[1]), d = u = l[h], p = parseFloat(f), _ = f.substr((p + "")
							.length), b = "=" === d.charAt(1), b ? (m = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), m *= parseFloat(d), y = d.substr((m + "")
							.length - (0 > m ? 1 : 0)) || "") : (m = parseFloat(d), y = d.substr((m + "")
							.length)), "" === y && (y = n[i] || _), y !== _ && (T = J(t, "borderLeft", p, _), x = J(t, "borderTop", p, _), "%" === y ? (f = T / g * 100 + "%", c = x / v * 100 + "%") : "em" === y ? (w = J(t, "borderLeft", 1, "em"), f = T / w + "em", c = x / w + "em") : (f = T + "px", c = x + "px"), b && (d = parseFloat(f) + m + y, u = parseFloat(c) + m + y)), s = bt(C, E[h], f + " " + c, d + " " + u, !1, "0px", s);
						return s
					},
					prefix: !0,
					...
					parser: function(t, e, i, n, o, s) {
						...
						if (-1 !== g.indexOf("%") != (-1 !== v.indexOf("%")) && v.split(",")
							.length < 2 && (f = Z(t, "backgroundImage")
								.replace(D, ""), f && "none" !== f)) {
					...
					parser: function(t, e, i, n, o, s) {
						var a, l, h;
						return 9 > m ? (l = t.currentStyle, h = 8 > m ? " " : ",", a = "rect(" + l.clipTop + h + l.clipRight + h + l.clipBottom + h + l.clipLeft + ")", e = this.format(e)
							.split(",")
							.join(h)) : (a = this.format(Z(t, this.p, r, !1, this.dflt)), e = this.format(e)), this.parseComplex(t.style, a, e, o, s)
					}
				}), wt("textShadow", {
				...
				var Yt = function(t) {
					if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
						...
						if ("all" === this.e) s.cssText = "", r = !0;
							...
							for (e = this.e.split(" ")
								.join("")
								.split(","), n = e.length; --n > -1;) i = e[n], l[i] && (l[i].parse === a ? r = !0 : i = "transformOrigin" === i ? Dt : l[i].p), Ut(s, i);
				...
				h = s.prototype, h._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a, h) {
					...
					if (c && "" === S.zIndex && (d = Z(t, "zIndex", r), ("auto" === d || "" === d) && this._addLazySet(S, "zIndex", 0)), "string" == typeof e && (_ = S.cssText, d = et(t, r), S.cssText = _ + ";" + e, d = it(t, d, et(t))
						.difs, !U && E.test(e) && (d.opacity = parseFloat(RegExp.$1)), e = d, S.cssText = _), e.className ? this._firstPT = m = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = m = this.parse(t, e, null), this._transformType) {
					...
					for (s in e) d = e[s], "function" == typeof d && (d = d(v, g)), a = l[s], a ? i = a.parse(t, d, s, this, i, o, e) : (f = Z(t, s, r) + "", y = "string" == typeof d, "color" === s || "fill" === s || "stroke" === s || -1 !== s.indexOf("Color") || y && S.test(d) ? (y || (d = ft(d), d = (d.length > 3 ? "rgba(" : "rgb(") + d.join(",") + ")"), i = bt(b, s, f, d, !0, "transparent", i, 0, o)) : y && R.test(d) ? i = bt(b, s, f, d, !0, null, i, 0, o) : (h = parseFloat(f), p = h || 0 === h ? f.substr((h + "")
						.length) : "", ("" === f || "auto" === f) && ("width" === s || "height" === s ? (h = ot(t, s, r), p = "px") : "left" === s || "top" === s ? (h = tt(t, s, r), p = "px") : (h = "opacity" !== s ? 0 : 1, p = "")), _ = y && "=" === d.charAt(1), _ ? (c = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), c *= parseFloat(d), m = d.replace(x, "")) : (c = parseFloat(d), m = y ? d.replace(x, "") : ""), "" === m && (m = s in n ? n[s] : p), d = c || 0 === c ? (_ ? c + h : c) + m : e[s], p !== m && "" !== m && (c || 0 === c) && h && (h = J(t, s, h, p), "%" === m ? (h /= J(t, s, 100, "%") / 100, e.strictUnits !== !0 && (f = h + "%")) : "em" === m || "rem" === m || "vw" === m || "vh" === m ? h /= J(t, s, 1, m) : "px" !== m && (c = J(t, s, c, m), m = "px"), _ && (c || 0 === c) && (d = c + h + m)), _ && (c += h), !h && 0 !== h || !c && 0 !== c ? void 0 !== b[s] && (d || d + "" != "NaN" && null != d) ? (i = new yt(b, s, c || h || 0, 0, i, -1, s, !1, 0, f, d), i.xs0 = "none" !== d || "display" !== s && -1 === s.indexOf("Style") ? d : f) : Y("invalid " + s + " tween value: " + e[s]) : (i = new yt(b, s, h, c - h, i, 0, s, u !== !1 && ("px" === m || "zIndex" === s), 0, f, d),
		...
		if (!n.TweenLite) {
			var r, o, s, a, l, h = function(t) {
				...
				g = function(r, o, s, a) {
					...
					this.check = function(u) {
						for (var c, f, d, p, v, y = o.length, _ = y; --y > -1;)(c = m[o[y]] || new g(o[y], []))
							.gsClass ? (l[y] = c.gsClass, _--) : u && c.sc.push(this);
						if (0 === _ && s) {
							if (f = ("com.greensock." + r)
								.split("."), d = f.pop(), p = h(f.join("."))[d] = this.gsClass = s.apply(s, l), a)
								if (n[d] = i[d] = p, v = "undefined" != typeof module && module.exports, !v && "function" == typeof define && define.amd) define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + r.split(".")
									.pop(), [],
									function() {
										return p
									});
			...
			var _ = [0, 0, 1, 1],
				...
				x = b.register = function(t, e, i, n) {
					for (var r, o, s, a, l = e.split(","), h = l.length, c = (i || "easeIn,easeOut,easeInOut")
						.split(","); --h > -1;)
			...
			s = P.prototype = new I, s.constructor = P, s.kill()
				._gc = !1, s._first = s._last = s._recent = null, s._sortChildren = !1, s.add = s.insert = function(t, e, i, n) {
					var r, o;
			...
			s = k.prototype = new I, s.constructor = k, s.kill()
				._gc = !1, s.ratio = 0, s._firstPT = s._targets = s._overwrittenProps = s._startAt = null, s._notifyPluginsOfEnabled = s._lazy = !1, k.version = "1.19.0", k.defaultEase = s._ease = new b(null, null, 1, 1), k.defaultOverwrite = "auto", k.ticker = a, k.autoSleep = 120, k.lagSmoothing = function(t, e) {
					a.lagSmoothing(t, e)
			...
			s._init = function() {
				...
				for (s in this.vars)
					if (c = this.vars[s], V[s]) c && (c instanceof Array || c.push && p(c)) && -1 !== c.join("")
						.indexOf("{self}") && (this.vars[s] = c = this._swapSelfInParams(c, this));
					else if (H[s] && (h = new H[s])
					._onInitTween(e, this.vars[s], this, o)) {
					for (this._firstPT = u = {
						_next: this._firstPT,
						t: h,
						p: "setRatio",
			...
			var tt = y("plugins.TweenPlugin", function(t, e) {
				this._overwriteProps = (t || "")
					.split(","), this._propName = this._overwriteProps[0], this._priority = e || 0, this._super = tt.prototype
			}, !0);
			if (s = tt.prototype, tt.version = "1.19.0", tt.API = 2, s._firstPT = null, s._addTween = F, s.setRatio = z, s._kill = function(t) {
				...
				for (var e = t.length; --e > -1;) t[e].API === tt.API && (H[(new t[e])
					._propName] = t[e]);
				return !0
			}, v.plugin = function(t) {
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window;
if ((_gsScope._gsQueue || (_gsScope._gsQueue = []))
	.push(function() {
		"use strict";
	...
	function(t) {
		...
		function u() {
			var t = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0],
				e = [];
			return Array.prototype.push.apply(e, arguments), e.slice(1)
				.forEach(function(e) {
					if (e)
						for (var i in e)({})
		...
		function c(t, e) {
			if ("undefined" != typeof t.classList) e.split(" ")
				.forEach(function(e) {
					e.trim() && t.classList.remove(e)
				});
			else {
				var i = new RegExp("(^| )" + e.split(" ")
						.join("|") + "( |$)", "gi"),
					n = p(t)
					.replace(i, " ");
				m(t, n)
				...
				function t(t, e) {
					...
					try {
						for (var s, a = t[Symbol.iterator](); !(n = (s = a.next())
							.done) && (i.push(s.value), !e || i.length !== e); n = !0);
					} catch (t) {
						r = !0, o = t
					} finally {
						try {
		...
		var W = {
			...
			Y = function(t) {
				function e(t) {
					var i = this;
					n(this, e), R(Object.getPrototypeOf(e.prototype), "constructor", this)
						.call(this), this.position = this.position.bind(this), j.push(this), this.history = [], this.setOptions(t, !1), E.modules.forEach(function(t) {
								...
								c = function(t, i) {
									...
									if (r !== !1) {
										...
										if (t.top ? (h.top = 0, o = i.top) : (h.bottom = 0, o = -i.bottom), t.left ? (h.left = 0, s = i.left) : (h.right = 0, s = -i.right), window.matchMedia) {
											var a = window.matchMedia("only screen and (min-resolution: 1.3dppx)")
												.matches || window.matchMedia("only screen and (-webkit-min-device-pixel-ratio: 1.3)")
												.matches;
		...
		E.modules.push({
			position: function(t) {
				...
				return this.options.constraints.forEach(function(t) {
					...
					var _ = x(e, o);
					("target" === c || "both" === c) && (i < _[1] && "top" === v.top && (i += f, v.top = "bottom"), i + s > _[3] && "bottom" === v.top && (i -= f, v.top = "top")), "together" === c && ("top" === v.top && ("bottom" === y.top && i < _[1] ? (i += f, v.top = "bottom", i += s, y.top = "top") : "top" === y.top && i + s > _[3] && i - (s - f) >= _[1] && (i -= s - f, v.top = "bottom", y.top = "bottom")), "bottom" === v.top && ("top" === y.top && i + s > _[3] ? (i -= f, v.top = "top", i -= s, y.top = "bottom") : "bottom" === y.top && i < _[1] && i + (2 * s - f) <= _[3] && (i += s - f, v.top = "top", y.top = "top")), "middle" === v.top && (i + s > _[3] && "top" === y.top ? (i -= s, y.top = "bottom") : i < _[1] && "bottom" === y.top && (i += s, y.top = "top"))), ("target" === u || "both" === u) && (n < _[0] && "left" === v.left && (n += d, v.left = "right"), n + l > _[2] && "right" === v.left && (n -= d, v.left = "left")), "together" === u && (n < _[0] && "left" === v.left ? "right" === y.left ? (n += d, v.left = "right", n += l, y.left = "left") : "left" === y.left && (n += d, v.left = "right", n -= l, y.left = "right") : n + l > _[2] && "right" === v.left ? "left" === y.left ? (n -= d, v.left = "left", n -= l, y.left = "right") : "right" === y.left && (n -= d, v.left = "left", n += l, y.left = "left") : "center" === v.left && (n + l > _[2] && "left" === y.left ? (n -= l, y.left = "right") : n < _[0] && "right" === y.left && (n += l, y.left = "left"))), ("element" === c || "both" === c) && (i < _[1] && "bottom" === y.top && (i += s, y.top = "top"), i + s > _[3] && "top" === y.top && (i -= s, y.top = "bottom")), ("element" === u || "both" === u) && (n < _[0] && ("right" === y.left ? (n += l, y.left = "left") : "center" === y.left && (n += l / 2, y.left = "left")), n + l > _[2] && ("left" === y.left ? (n -= l, y.left = "right") : "center" === y.left && (n -= l / 2, y.left = "right"))), "string" == typeof h ? h = h.split(",")
						.map(function(t) {
							return t.trim()
	...
	var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
						...
						for (var o in r)
							if (r.hasOwnProperty(o)) {
								var s = r[o],
									a = n[o],
									l = void 0;
								if (l = a && i(a) ? "element" : e(a), !new RegExp(s)
									.test(l)) throw new Error(t.toUpperCase() + ": " + ('Option "' + o + '" provided type "' + l + '" ') + ('but expected type "' + s + '".'))
							}
					}
				};
			return s(), u
		...
		s = (function(t) {
			var e = "alert",
				...
				p = function() {
					...
					return e.prototype.close = function(t) {
						...
						var i = this;
						return t(e)
							.removeClass(d.ACTIVE), o.supportsTransitionEnd() && t(e)
							.hasClass(d.FADE) ? void t(e)
			...
			return t(document)
				.on(f.CLICK_DATA_API, c.DISMISS, p._handleDismiss(new p)), t.fn[e] = p._jQueryInterface, t.fn[e].Constructor = p, t.fn[e].noConflict = function() {
			...
			var e = "button",
				...
				f = function() {
					...
					return e.prototype.toggle = function() {
						var e = !0,
							i = t(this._element)
							.closest(u.DATA_TOGGLE)[0];
						if (i) {
							var n = t(this._element)
								.find(u.INPUT)[0];
							if (n) {
								if ("radio" === n.type)
									if (n.checked && t(this._element)
										.hasClass(h.ACTIVE)) e = !1;
									else {
										var r = t(i)
											.find(u.ACTIVE)[0];
										r && t(r)
											.removeClass(h.ACTIVE)
									} e && (n.checked = !t(this._element)
									.hasClass(h.ACTIVE), t(this._element)
									.trigger("change")), n.focus()
							}
						} else this._element.setAttribute("aria-pressed", !t(this._element)
							.hasClass(h.ACTIVE));
						e && t(this._element)
							.toggleClass(h.ACTIVE)
					}, e.prototype.dispose = function() {
						...
						return this.each(function() {
							var n = t(this)
								.data(o);
							n || (n = new e(this), t(this)
								.data(o, n)), "toggle" === i && n[i]()
						})
					}, r(e, null, [{
						key: "VERSION",
						get: function() {
			...
			return t(document)
				.on(c.CLICK_DATA_API, u.DATA_TOGGLE_CARROT, function(e) {
					...
					var i = e.target;
					t(i)
						.hasClass(h.BUTTON) || (i = t(i)
							.closest(u.BUTTON)), f._jQueryInterface.call(t(i), "toggle")
				})
				.on(c.FOCUS_BLUR_DATA_API, u.DATA_TOGGLE_CARROT, function(e) {
					var i = t(e.target)
						.closest(u.BUTTON)[0];
					t(i)
						.toggleClass(h.FOCUS, /^focus(in)?$/.test(e.type))
			...
			var e = "carousel",
				...
				b = function() {
					function h(e, n) {
						i(this, h), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this._config = this._getConfig(n), this._element = t(e)[0], this._indicatorsElement = t(this._element)
							.find(_.INDICATORS)[0], this._addEventListeners()
					}
					return h.prototype.next = function() {
						...
						e || (this._isPaused = !0), t(this._element)
							.find(_.NEXT_PREV)[0] && o.supportsTransitionEnd() && (o.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
						...
						this._activeElement = t(this._element)
							.find(_.ACTIVE_ITEM)[0];
						var n = this._getItemIndex(this._activeElement);
						if (!(e > this._items.length - 1 || e < 0)) {
							if (this._isSliding) return void t(this._element)
								.one(v.SLID, function() {
									return i.to(e)
								});
						...
						t(this._element)
							.off(l), t.removeData(this._element, a), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
						...
						this._config.keyboard && t(this._element)
							.on(v.KEYDOWN, function(t) {
								return e._keydown(t)
							}), "hover" !== this._config.pause || "ontouchstart" in document.documentElement || t(this._element)
						...
						return this._items = t.makeArray(t(e)
							.parent()
							.find(_.ITEM)), this._items.indexOf(e)
						...
						if (s && t(s)
							.hasClass(y.ACTIVE)) return void(this._isSliding = !1);
						...
						if (!h.isDefaultPrevented() && r && s) {
							...
							o.supportsTransitionEnd() && t(this._element)
								.hasClass(y.SLIDE) ? (t(s)
									.addClass(e), o.reflow(s), t(r)
									.addClass(l), t(s)
									.addClass(l), t(r)
									.one(o.TRANSITION_END, function() {
										t(s)
											.removeClass(l)
											.removeClass(e), t(s)
											.addClass(y.ACTIVE), t(r)
											.removeClass(y.ACTIVE)
											.removeClass(e)
											.removeClass(l), n._isSliding = !1, setTimeout(function() {
												return t(n._element)
													.trigger(u)
											}, 0)
									})
									.emulateTransitionEnd(c)) : (t(r)
									.removeClass(y.ACTIVE), t(s)
									.addClass(y.ACTIVE), this._isSliding = !1, t(this._element)
									.trigger(u)), a && this.cycle()
						}
						...
						return this.each(function() {
							...
							if (i || (i = new h(this, r), t(this)
								.data(a, i)), "number" == typeof e) i.to(e);
						...
						if (i) {
							...
							if (n && t(n)
								...
								s && (r.interval = !1), h._jQueryInterface.call(t(n), r), s && t(n)
									.data(a)
			...
			return t(document)
				.on(v.CLICK_DATA_API, _.DATA_SLIDE, b._dataApiClickHandler), t(window)
				.on(v.LOAD_DATA_API, function() {
					t(_.DATA_RIDE)
						.each(function() {
							var e = t(this);
			...
			var e = "collapse",
				...
				y = function() {
					...
					return l.prototype.toggle = function() {
						t(this._element)
							.hasClass(m.ACTIVE) ? this.hide() : this.show()
						...
						if (!this._isTransitioning && !t(this._element)
							...
							var i = void 0,
								n = void 0;
							if (this._parent && (i = t.makeArray(t(this._parent)
								.find(v.ACTIVES)), i.length || (i = null)), !(i && (n = t(i)
								.data(a), n && n._isTransitioning))) {
								var r = t.Event(p.SHOW);
								if (t(this._element)
									.trigger(r), !r.isDefaultPrevented()) {
									i && (l._jQueryInterface.call(t(i), "hide"), n || t(i)
										.data(a, null));
									var s = this._getDimension();
									t(this._element)
										.removeClass(m.COLLAPSE)
										.addClass(m.COLLAPSING), this._element.style[s] = 0, this._element.setAttribute("aria-expanded", !0), this._triggerArray.length && t(this._triggerArray)
									...
									var h = function() {
										t(e._element)
											...
											.addClass(m.COLLAPSE)
											.addClass(m.ACTIVE), e._element.style[s] = "", e.setTransitioning(!1), t(e._element)
											.trigger(p.SHOWN)
									};
									...
									t(this._element)
										...
										.emulateTransitionEnd(c), this._element.style[s] = this._element[f] + "px"
								}
							}
						}
						...
						if (!this._isTransitioning && t(this._element)
							...
							if (t(this._element)
								...
								this._element.style[n] = this._element[r] + "px", o.reflow(this._element), t(this._element)
									.addClass(m.COLLAPSING)
									.removeClass(m.COLLAPSE)
									.removeClass(m.ACTIVE), this._element.setAttribute("aria-expanded", !1), this._triggerArray.length && t(this._triggerArray)
								...
								return this._element.style[n] = "", o.supportsTransitionEnd() ? void t(this._element)
									.one(o.TRANSITION_END, s)
									.emulateTransitionEnd(c) : void s()
							}
						}
						...
						if (e) {
							var n = t(e)
								.hasClass(m.ACTIVE);
							e.setAttribute("aria-expanded", n), i.length && t(i)
			...
			return t(document)
				.on(p.CLICK_DATA_API, v.DATA_TOGGLE, function(e) {
					e.preventDefault();
			...
			var e = "dropdown",
				...
				v = function() {
					...
					return e.prototype.toggle = function() {
						if (this.disabled || t(this)
							.hasClass(m.DISABLED)) return !1;
						var i = e._getParentFromElement(this),
							n = t(i)
							.hasClass(m.ACTIVE);
						if (e._clearMenus(), n) return !1;
						if ("ontouchstart" in document.documentElement && !t(i)
							.closest(g.NAVBAR_NAV)
							.length) {
							var r = document.createElement("div");
							r.className = m.BACKDROP, t(r)
								.insertBefore(this), t(r)
								.on("click", e._clearMenus)
						}
						var o = {
								relatedTarget: this
							},
							s = t.Event(p.SHOW, o);
						return t(i)
							.trigger(s), !s.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", "true"), t(i)
								.toggleClass(m.ACTIVE), t(i)
								.trigger(t.Event(p.SHOWN, o)), !1)
					}, e.prototype.dispose = function() {
						t.removeData(this._element, s), t(this._element)
							.off(a), this._element = null
					}, e.prototype._addEventListeners = function() {
						t(this._element)
							.on(p.CLICK, this.toggle)
					}, e._jQueryInterface = function(i) {
						return this.each(function() {
							var n = t(this)
								.data(s);
							if (n || t(this)
								.data(s, n = new e(this)), "string" == typeof i) {
						...
						if (!i || i.which !== d) {
							...
							for (var r = t.makeArray(t(g.DATA_TOGGLE)), o = 0; o < r.length; o++) {
								...
								if (t(s)
									.hasClass(m.ACTIVE) && !(i && "click" === i.type && /input|textarea/i.test(i.target.tagName) && t.contains(s, i.target))) {
									var l = t.Event(p.HIDE, a);
									t(s)
										.trigger(l), l.isDefaultPrevented() || (r[o].setAttribute("aria-expanded", "false"), t(s)
						...
						if (/(38|40|27|32)/.test(i.which) && !/input|textarea/i.test(i.target.tagName) && (i.preventDefault(), i.stopPropagation(), !this.disabled && !t(this)
							.hasClass(m.DISABLED))) {
			...
			var e = "modal",
				...
				_ = function() {
					function h(e, n) {
						i(this, h), this._config = this._getConfig(n), this._element = e, this._dialog = t(e)
							.find(y.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
					}
					return h.prototype.toggle = function(t) {
						...
						t(this._element)
							.trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), t(document.body)
								.addClass(v.OPEN), this._setEscapeEvent(), this._setResizeEvent(), t(this._element)
								.on(g.CLICK_DISMISS, y.DATA_DISMISS, function(t) {
									return i.hide(t)
								}), t(this._dialog)
								.on(g.MOUSEDOWN_DISMISS, function() {
									t(i._element)
										.one(g.MOUSEUP_DISMISS, function(e) {
											t(e.target)
												.is(i._element) && (i._ignoreBackdropClick = !0)
										})
						...
						t(this._element)
							.trigger(n), this._isShown && !n.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), t(document)
								.off(g.FOCUSIN), t(this._element)
								.removeClass(v.ACTIVE), t(this._element)
								.off(g.CLICK_DISMISS), t(this._dialog)
								.off(g.MOUSEDOWN_DISMISS), o.supportsTransitionEnd() && t(this._element)
								.hasClass(v.FADE) ? t(this._element)
								.one(o.TRANSITION_END, function(t) {
									return i._hideModal(t)
								})
								.emulateTransitionEnd(c) : this._hideModal())
					}, h.prototype.dispose = function() {
						t.removeData(this._element, a), t(window)
							.off(l), t(document)
							.off(l), t(this._element)
							.off(l), t(this._backdrop)
							.off(l), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._originalBodyPadding = null, this._scrollbarWidth = null
					}, h.prototype._getConfig = function(i) {
						return i = t.extend({}, p, i), o.typeCheckConfig(e, i, m), i
					}, h.prototype._showElement = function(e) {
						var i = this,
							n = o.supportsTransitionEnd() && t(this._element)
							.hasClass(v.FADE);
						this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && o.reflow(this._element), t(this._element)
							.addClass(v.ACTIVE), this._config.focus && this._enforceFocus();
						var r = t.Event(g.SHOWN, {
								relatedTarget: e
							}),
							s = function() {
								i._config.focus && i._element.focus(), t(i._element)
									.trigger(r)
							};
						n ? t(this._dialog)
							.one(o.TRANSITION_END, s)
							.emulateTransitionEnd(c) : s()
					}, h.prototype._enforceFocus = function() {
						var e = this;
						t(document)
							.off(g.FOCUSIN)
							.on(g.FOCUSIN, function(i) {
								document === i.target || e._element === i.target || t(e._element)
									.has(i.target)
						...
						this._isShown && this._config.keyboard ? t(this._element)
							.on(g.KEYDOWN_DISMISS, function(t) {
								t.which === d && e.hide()
							}) : this._isShown || t(this._element)
							.off(g.KEYDOWN_DISMISS)
					}, h.prototype._setResizeEvent = function() {
						var e = this;
						this._isShown ? t(window)
							.on(g.RESIZE, function(t) {
						...
						this._element.style.display = "none", this._element.setAttribute("aria-hidden", "true"), this._showBackdrop(function() {
							t(document.body)
								.removeClass(v.OPEN), e._resetAdjustments(), e._resetScrollbar(), t(e._element)
								.trigger(g.HIDDEN)
						})
						...
						var i = this,
							n = t(this._element)
							.hasClass(v.FADE) ? v.FADE : "";
						if (this._isShown && this._config.backdrop) {
							var r = o.supportsTransitionEnd() && n;
							if (this._backdrop = document.createElement("div"), this._backdrop.className = v.BACKDROP, n && t(this._backdrop)
								.addClass(n), t(this._backdrop)
								.appendTo(document.body), t(this._element)
								.on(g.CLICK_DISMISS, function(t) {
								...
								}), r && o.reflow(this._backdrop), t(this._backdrop)
								.addClass(v.ACTIVE), !e) return;
							if (!r) return void e();
							t(this._backdrop)
							...
							o.supportsTransitionEnd() && t(this._element)
								.hasClass(v.FADE) ? t(this._backdrop)
								.one(o.TRANSITION_END, s)
								.emulateTransitionEnd(f) : s()
						} else e && e()
						...
						var e = parseInt(t(y.FIXED_CONTENT)
						...
						return this.each(function() {
							var r = t(this)
								.data(a),
								o = t.extend({}, h.Default, t(this)
									.data(), "object" === ("undefined" == typeof e ? "undefined" : n(e)) && e);
							if (r || (r = new h(this, o), t(this)
								.data(a, r)), "string" == typeof e) {
								if (void 0 === r[e]) throw new Error('No method named "' + e + '"');
								r[e](i)
			...
			return t(document)
				.on(g.CLICK_DATA_API, y.DATA_TOGGLE, function(e) {
					var i = this,
						n = void 0,
						r = o.getSelectorFromElement(this);
					r && (n = t(r)[0]);
					var s = t(n)
						.data(a) ? "toggle" : t.extend({}, t(n)
							.data(), t(this)
							.data());
					"A" === this.tagName && e.preventDefault();
					var l = t(n)
						.one(g.SHOW, function(e) {
			...
			var e = "scrollspy",
				...
				v = function() {
					function h(e, n) {
						var r = this;
						i(this, h), this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(n), this._selector = this._config.target + " " + m.NAV_LINKS + "," + (this._config.target + " " + m.DROPDOWN_ITEMS), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement)
							.on(d.SCROLL, function(t) {
								return r._process(t)
					...
					return h.prototype.refresh = function() {
						...
						s.map(function(e) {
								...
								return s && (i = t(s)[0]), i && (i.offsetWidth || i.offsetHeight) ? [t(i)[n]()
									.top + r, s
								] : null
							})
							.filter(function(t) {
						...
						t.removeData(this._element, a), t(this._scrollElement)
							.off(l), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
					}, h.prototype._getConfig = function(i) {
						if (i = t.extend({}, c, i), "string" != typeof i.target) {
							var n = t(i.target)
								.attr("id");
							n || (n = o.getUID(e), t(i.target)
								.attr("id", n)), i.target = "#" + n
						}
						...
						var n = t(i.join(","));
						n.hasClass(p.DROPDOWN_ITEM) ? (n.closest(m.DROPDOWN)
								.find(m.DROPDOWN_TOGGLE)
								.addClass(p.ACTIVE), n.addClass(p.ACTIVE)) : n.parents(m.LI)
							.find(m.NAV_LINKS)
							.addClass(p.ACTIVE), t(this._scrollElement)
							.trigger(d.ACTIVATE, {
								relatedTarget: e
							})
				...
				p = function() {
					...
					return e.prototype.show = function() {
						...
						if (!this._element.parentNode || this._element.parentNode.nodeType !== Node.ELEMENT_NODE || !t(this._element)
							...
							if (n && t(n)
								.trigger(a), t(this._element)
								.trigger(l), !l.isDefaultPrevented() && !a.isDefaultPrevented()) {
						...
						var r = this,
							s = t(i)
							.find(d.ACTIVE_CHILD)[0],
							a = n && o.supportsTransitionEnd() && (s && t(s)
								.hasClass(f.FADE) || Boolean(t(i)
									.find(d.FADE_CHILD)[0])),
							l = function() {
						...
						s && a ? t(s)
							...
							.emulateTransitionEnd(u) : l(), s && t(s)
							.removeClass(f.IN)
						...
						if (i) {
							...
							s && t(s)
								.removeClass(f.ACTIVE), i.setAttribute("aria-expanded", !1)
						}
						if (t(e)
							.addClass(f.ACTIVE), e.setAttribute("aria-expanded", !0), n ? (o.reflow(e), t(e)
								.addClass(f.IN)) : t(e)
							.removeClass(f.FADE), e.parentNode && t(e.parentNode)
							.hasClass(f.DROPDOWN_MENU)) {
							var a = t(e)
								.closest(d.DROPDOWN)[0];
							a && t(a)
								.find(d.DROPDOWN_TOGGLE)
								.addClass(f.ACTIVE), e.setAttribute("aria-expanded", !0)
						}
						r && r()
					}, e._jQueryInterface = function(i) {
						return this.each(function() {
					...
					return h.prototype.enable = function() {
						...
						if (e) {
							var i = this.constructor.DATA_KEY,
								n = t(e.currentTarget)
								.data(i);
							n || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget)
								.data(i, n)), n._activeTrigger.click = !n._activeTrigger.click, n._isWithActiveTrigger() ? n._enter(null, n) : n._leave(null, n)
						} else {
							if (t(this.getTipElement())
								.hasClass(v.ACTIVE)) return void this._leave(null, this);
							this._enter(null, this)
						}
					}, h.prototype.dispose = function() {
						clearTimeout(this._timeout), this.cleanupTether(), t.removeData(this.element, this.constructor.DATA_KEY), t(this.element)
							.off(this.constructor.EVENT_KEY), this.tip && t(this.tip)
						...
						if (this.isWithContent() && this._isEnabled) {
							...
							r.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation && t(r)
								.addClass(v.FADE);
							var a = "function" == typeof this.config.placement ? this.config.placement.call(this, r, this.element) : this.config.placement,
								l = this._getAttachment(a);
							t(r)
								.data(this.constructor.DATA_KEY, this)
								.appendTo(document.body), t(this.element)
								.trigger(this.constructor.Event.INSERTED), this._tether = new Tether({
									...
									addTargetClasses: !1
								}), o.reflow(r), this._tether.position(), t(r)
								.addClass(v.ACTIVE);
							var u = function() {
								var i = e._hoverState;
								e._hoverState = null, t(e.element)
									.trigger(e.constructor.Event.SHOWN), i === m.OUT && e._leave(null, e)
							};
							if (o.supportsTransitionEnd() && t(this.tip)
								.hasClass(v.FADE)) return void t(this.tip)
						...
						var i = this,
							...
							s = function() {
								i._hoverState !== m.ACTIVE && n.parentNode && n.parentNode.removeChild(n), i.element.removeAttribute("aria-describedby"), t(i.element)
									.trigger(i.constructor.Event.HIDDEN), i.cleanupTether(), e && e()
							};
						t(this.element)
							.trigger(r), r.isDefaultPrevented() || (t(n)
								.removeClass(v.ACTIVE), o.supportsTransitionEnd() && t(this.tip)
								.hasClass(v.FADE) ? t(n)
								.one(o.TRANSITION_END, s)
								.emulateTransitionEnd(u) : s(), this._hoverState = "")
						...
						this.setElementContent(e.find(y.TOOLTIP_INNER), this.getTitle()), e.removeClass(v.FADE)
							.removeClass(v.ACTIVE), this.cleanupTether()
					}, h.prototype.setElementContent = function(e, i) {
						var r = this.config.html;
						"object" === ("undefined" == typeof i ? "undefined" : n(i)) && (i.nodeType || i.jquery) ? r ? t(i)
							.parent()
							.is(e) || e.empty()
							.append(i) : e.text(t(i)
								.text()): e[r ? "html" : "text"](i)
						...
						return i = i || t(e.currentTarget)
							.data(n), i || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget)
								.data(n, i)), e && (i._activeTrigger["focusin" === e.type ? b.FOCUS : b.HOVER] = !0), t(i.getTipElement())
							.hasClass(v.ACTIVE) || i._hoverState === m.ACTIVE ? void(i._hoverState = m.ACTIVE) : (clearTimeout(i._timeout), i._hoverState = m.ACTIVE, i.config.delay && i.config.delay.show ? void(i._timeout = setTimeout(function() {
								i._hoverState === m.ACTIVE && i.show()
							}, i.config.delay.show)) : void i.show())
					}, h.prototype._leave = function(e, i) {
						var n = this.constructor.DATA_KEY;
						if (i = i || t(e.currentTarget)
							.data(n), i || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget)
								.data(n, i)), e && (i._activeTrigger["focusout" === e.type ? b.FOCUS : b.HOVER] = !1), !i._isWithActiveTrigger()) return clearTimeout(i._timeout), i._hoverState = m.OUT, i.config.delay && i.config.delay.hide ? void(i._timeout = setTimeout(function() {
						...
						return i = t.extend({}, this.constructor.Default, t(this.element)
							.data(), i), i.delay && "number" == typeof i.delay && (i.delay = {
							show: i.delay,
							hide: i.delay
						...
						return this.each(function() {
							var i = t(this)
								.data(a),
								r = "object" === ("undefined" == typeof e ? "undefined" : n(e)) ? e : null;
							if ((i || !/dispose|hide/.test(e)) && (i || (i = new h(this, r), t(this)
								.data(a, i)), "string" == typeof e)) {
								if (void 0 === i[e]) throw new Error('No method named "' + e + '"');
								i[e]()
							}
		...
		var a = "popover",
			...
			v = function(s) {
				...
				return e(c, s), c.prototype.isWithContent = function() {
					...
					this.setElementContent(t.find(m.TITLE), this.getTitle()), this.setElementContent(t.find(m.CONTENT), this._getContent()), t.removeClass(p.FADE)
						.removeClass(p.ACTIVE), this.cleanupTether()
					...
					return this.each(function() {
						...
						if ((e || !/destroy|hide/.test(t)) && (e || (e = new c(this, i), o(this)
							.data(h, e)), "string" == typeof t)) {
	...
	var r, o, s = function() {
			...
			.insertBefore(i, null);
			for (var r in n) "undefined" != typeof i.style[r] && (i.style[r] = "translate3d(1px,1px,1px)", e = t.getComputedStyle(i)
				.getPropertyValue(n[r]));
			return (document.body || document.documentElement)
				.removeChild(i), "undefined" != typeof e && e.length > 0 && "none" !== e
		}(),
	...
	m.prototype.css = function(e, i) {
		if ("string" == typeof i) return t.getComputedStyle ? t.getComputedStyle(e)
			.getPropertyValue(i) : e.style[i];
		...
		var t = this;
		return null === t.image.src && (t.image.src = t.css(t.$item, "background-image")
			.replace(/^url\(['"]?/g, "")
			.replace(/['"]?\)$/g, "")), !(!t.image.src || "none" === t.image.src)
	...
	r.prototype.play = function(t) {
		var e = this;
		e.player && ("youtube" === e.type && e.player.playVideo && ("undefined" != typeof t && e.player.seekTo(t || 0), e.player.playVideo()), "vimeo" !== e.type || o || ("undefined" != typeof t ? (o = 1, e.player.setCurrentTime(t || 0)
			.then(function() {
				e.player.play(), o = 0
	...
	if ("undefined" != typeof jarallax) {
		...
		t.prototype.coverImage = function() {
			...
			i.apply(t), t.video && "IFRAME" === t.image.$item.nodeName && t.css(t.image.$item, {
				height: t.image.$item.getBoundingClientRect()
					.height + 400 + "px",
...
function(t, e) {
	...
	n.extend(p, e.prototype), p._create = function() {
		...
		this.slideableWidth = e, this.updateSlides(), this._containSlides(), this.slidesWidth = n ? this.getLastSlide()
	...
	return p.setCellAlign = function() {
		...
		if (this.options.contain && !this.options.wrapAround && this.cells.length) {
			var t = this.options.rightToLeft,
				...
				n = this.slideableWidth - this.getLastCell()
				.size[i],
...
function(t, e) {
	...
	return o.pointerDownFocus = function(e) {
		...
		if (!this.options.wrapAround && this.slides.length) {
			...
			r = r > o ? .5 * (r + o) : r;
			var s = Math.min(-this.getLastSlide()
...
function(t, e) {
	...
	Y.prototype = {
		set: function(t) {
			t == se && (t = this.compute()), oe && this.manager.element.style && fe[t] && (this.manager.element.style[re] = t), this.actions = t.toLowerCase()
				.trim()
		},
		update: function() {
		...
		.style, L = function() {
			...
			return h.prototype.preventScrolling = function(t, e) {
				...
				this.events = {
					down: function(t) {
						return function(e) {
							return t.isBeingDragged = !0, t.offsetY = e.pageY - t.slider.offset()
								.top, t.slider.is(e.target) || (t.offsetY = 0), t.pane.addClass("active"), t.doc.bind(d, t.events[a])
								.bind(p, t.events[x]), t.body.bind(f, t.events[l]), !1
						}
					}(this),
					drag: function(t) {
						return function(e) {
							return t.sliderY = e.pageY - t.$el.offset()
								.top - t.paneTop - (t.offsetY || .5 * t.sliderHeight), t.scroll(), t.contentScrollTop >= t.maxScrollTop && t.prevScrollTop !== t.maxScrollTop ? t.$el.trigger("scrollend") : 0 === t.contentScrollTop && 0 !== t.prevScrollTop && t.$el.trigger("scrolltop"), !1
						}
					}(this),
					up: function(t) {
						return function(e) {
							return t.isBeingDragged = !1, t.pane.removeClass("active"), t.doc.unbind(d, t.events[a])
								.unbind(p, t.events[x]), t.body.unbind(f, t.events[l]), !1
						}
					}(this),
					resize: function(t) {
						return function(e) {
				...
				var t;
				this.removeEvents(), t = this.events, this.options.disableResize || this.win.bind(y, t[y]), this.iOSNativeScrolling || (this.slider.bind(c, t[s]), this.pane.bind(c, t[v])
					.bind("" + m + " " + o, t[w])), this.$content.bind("" + _ + " " + m + " " + o + " " + T, t[_])
				...
				var t, i, n, o, s, a, l;
				return o = this.options, a = o.paneClass, l = o.sliderClass, t = o.contentClass, (s = this.$el.children("." + a))
					.length || s.children("." + l)
					.length || this.$el.append('<div class="' + a + '"><div class="' + l + '" /></div>'), this.pane = this.$el.children("." + a), this.slider = this.pane.find("." + l), 0 === r && I() ? (n = e.getComputedStyle(this.content, null)
				...
				return this.iOSNativeScrolling ? void(this.contentHeight = this.content.scrollHeight) : (this.$el.find("." + this.options.paneClass)
					.length || this.generate()
					.stop(), this.stopped && this.restore(), t = this.content, o = t.style, s = o.overflowY, n && this.$content.css({
				...
				return this.isActive ? (this.$content.scrollTop(this.contentHeight - this.$content.height() - t)
					.trigger(m), this.stop()
					.restore(), this) : void 0
			}, h.prototype.scrollTop = function(t) {
				return this.isActive ? (this.$content.scrollTop(+t)
					.trigger(m), this.stop()
					.restore(), this) : void 0
			}, h.prototype.scrollTo = function(t) {
				return this.isActive ? (this.scrollTop(this.$el.find(t)
					.get(0)
...
function() {
	...
	function a() {
		"undefined" == typeof z && (z = C.css("padding-right") || ""), R && C.add(j)
			.css("paddingRight", M + "px")
	}
	...
	function u(t, e) {
		var i = !1,
			n = .7;
		i = "top" === t ? 0 : "bottom" === t ? Math.max(0, I - A) : "number" == typeof t ? t : !!t.offset && t.offset()
			.top, i !== !1 && w.scrollTop() !== i ? (T.to(w, n, {
				scrollTo: {
					y: i,
					autoKill: !0
				},
	...
	function c() {
		...
		function e(t) {
			if (t.parent()
				...
				a > s.left && (r.marginLeft = (r.marginLeft || 0) - (a - s.left)), n && (r.marginRight = -1 * r.marginLeft, r.marginLeft = ""), r.marginTop = i.innerHeight() - e.offset()
					.top + i.offset()
					.top, r.display = "none", e.css(r)
			}
		}
		...
		s.length && s.each(function() {
			var t = b(b(this)
					.html()),
				e = b(b(this)
					.attr("data-nav-mobile"));
			e.find(".nk-navbar-mobile-content > ul.nk-nav")
				.append(t)
		});
		var a = o.length ? o.offset()
			.top : 0,
			l = b("<div>")
			.hide();
	...
	function f() {
		...
		t.fullscreenNavbarIsOpened = function() {
			...
			if (!n && e.length) {
				...
				r.length || (r = e.find(".nk-nav > li > a")), b(".nk-navbar-full-toggle")
					.addClass("active"), T.set(r, {
						opacity: 0,
						force3D: !0
					}), T.set(i, {
						opacity: 0,
			...
			n && e.length && (n = 0, b(".nk-navbar-full-toggle")
				.removeClass("active"), T.to(e, .5, {
					opacity: 0,
					force3D: !0,
					display: "none",
					onComplete: function() {
	...
	function d() {
		...
		var i = this,
			n = b(".nk-navbar-full");
		n.find(".dropdown")
			.prepend('<li class="bropdown-back"><a href="#">Back</a></li>'), n.on("click", ".nk-drop-item > a", function(i) {
				e(!0, b(this)
					.parent()), t(b(this)), i.preventDefault()
	...
	function p() {
		...
		function i() {
			for (var t = 0; t < s.length; t++) {
				var e = s[t],
					i = 0,
					n = A;
				e.$block.length && (i = e.$block.offset()
					.top, n = e.$block.innerHeight()), e.activate = i - A / 2, e.deactivate = i + n - A / 2
			}
		}
		...
		E.on("click", ".nk-navbar a, a.nk-header-title-scroll-down", function(e) {
			...
			if (i && n) {
				var o = b(i),
					s = i.replace(/^#/, "");
				(o.length || "top" === s || "bottom" === s) && (t(), o.length && !b(this)
					.hasClass("nk-header-title-scroll-down") && (o.attr("id", ""), document.location.hash = s, o.attr("id", s)), r.scrollTo(o.length ? o : s), e.preventDefault())
			}
		});
	...
	function m(t) {
		"undefined" != typeof b.fn.nanoScroller && (t || E)
			.find(".nano")
			.nanoScroller()
	}
	...
	function v() {
		...
		if ("undefined" != typeof window.Flickity) {
			var e = b(".nk-carousel");
			e.length && (e.children(".nk-carousel-inner")
					.each(function() {
						b(this)
							.flickity({
								pageDots: "true" === b(this)
									.parent()
									.attr("data-dots") || !1,
								autoPlay: parseFloat(b(this)
									.parent()
					...
					}), t(e.children(".nk-carousel-inner"))), b(".nk-carousel-2 > .nk-carousel-inner")
				.each(function() {
					b(this)
						.flickity({
							pageDots: "true" === b(this)
			...
			b(".nk-isotope")
				.each(function() {
					...
					n = e.parent()
						...
						.prev(".nk-isotope-filter") : e.prev(".nk-isotope-filter"), n.length && n.on("click", "[data-filter]", function(t) {
							t.preventDefault();
							var e = b(this)
								.attr("data-filter");
							b(this)
	...
	b("html")
		.addClass(x ? "is-mobile" : "is-desktop");
	var w = b(window),
		E = b(document),
		C = b("body"),
		S = 0,
